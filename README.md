...
> **⏱ Timing disclaimer:** Average durations are **indicative only**. The
> benchmark does not run on a fully isolated machine — background processes,
> thermal throttling, and other workloads may introduce timing fluctuations
> between runs.
